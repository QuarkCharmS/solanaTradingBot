...
def swap(private_key, amount=None, input_token=SOLANA_MINT, output_token=SOLANA_MINT, slippageBps='50'):
    ...
    swap_result = exec_code(f"PRIVATE_KEY={private_key} INPUT_MINT={input_token} OUTPUT_TOKEN={output_token} AMOUNT={amount} SLIPPAGE_BPS={slippageBps} node jupiter-swap.js",
